...
var obj_360_exists = instance_exists(res_select_object_360);

if (obj_1080_exists && obj_720_exists && obj_360_exists) {
	...
	var new_y_360 = new_y_720 + sprite_get_height(sprite_index) * 1.5; // Position res_select_object_320 below res_select_object_720
	...
	var obj_360 = instance_create_layer(new_x, new_y_360, layer, res_select_object_360);
    obj_360.image_xscale = 1.5;
    obj_360.image_yscale = 1.5;
}
