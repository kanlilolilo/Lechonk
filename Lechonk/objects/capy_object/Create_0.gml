...
melee_cooldown = 0; // Timer for melee attack cooldown
melee_dash_speed = 5; // Speed of lunge during melee attack
melee_reach = 20; // Range of the melee attack
melee_damage = 10; // Damage dealt by the melee attack

dash_duration = 10; // Duration of the dash in steps
dash_base_speed = 15
dash_timer = 0;
is_dashing = false;