...
if (global.selection_turn == 1) {
    global.p1_selected_character = shylily_idle_object; // Store the id of the selected character for Player 1
    global.selection_turn = 2; // Switch to Player 2's turn
} else if (global.selection_turn == 2) {
    global.p2_selected_character = shylily_idle_object; // Store the id of the selected character for Player 2
